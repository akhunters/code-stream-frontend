...
const GoogleSvg = (props: React.RefAttributes<SVGSVGElement>) => (
    <svg
...
export const GoogleIcon: React.ForwardRefExoticComponent<Omit<LucideProps, "ref"> & React.RefAttributes<SVGSVGElement>> = React.forwardRef((props, ref) => (
    <GoogleSvg {...props} ref={ref} />
));